            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.popmenu_delete:
                    try {
                        ...
                        Utils.showErrorMessage(activity, activity.findViewById(R.id.main_content),Utils.getColorFromAttr(activity, R.attr.color_secondary), getString(R.string.delete_msg));
